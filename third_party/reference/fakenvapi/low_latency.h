...
// Upstream: https://github.com/optiscaler/fakenvapi
// Revision: c39271ab990fab3b80ebac93a593b963cdac0f0d
// Original path: src/low_latency.h
// Copyright (c) 2026 Michał Lewandowski
//
// This file is retained as an isolated reference snapshot. It is not part of
// the ISB build and its Windows/NVAPI dependencies are intentionally not
// introduced into ISB core.
...
public:
    ...
    NvAPI_Status SetAsyncFrameMarker(ID3D12CommandQueue *pCommandQueue, NV_ASYNC_FRAME_MARKER_PARAMS *pSetLatencyMarkerParams);
